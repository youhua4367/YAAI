...
const STATIC_SHORTCUTS: ShortcutItem[] = [
  {
    title: '会员注册',
    desc: '在线提交入会申请',
    icon: 'https://img.icons8.com/fluency/48/add-user-male.png',
    url: '/apply'
  },
  {
    title: '会员登录',
...
.shortcut-item:hover {
  ...
  box-shadow: 0 10px 20px rgba(12, 77, 162, 0.08);
...
.shortcut-item:hover .entry-arrow {
  opacity: 1;
